...
| UI | Web UI / RESTful API / CLI (`semiclaw`) / Chrome Extension / WeChat 미니 프로그램 |
...
| 모델 관리 | 중앙 설정, YAML 선언형 내장 모델 구성, 지식베이스별 모델 선택, 모델별 사고 모드 설정, 멀티테넌트 내장 모델 공유, SemiClaw Cloud 호스팅 모델 및 문서 파싱 |

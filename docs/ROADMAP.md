...
本文档描述 SemiClaw 的产品规划与计划方向，会随项目进展持续更新。

## 轻量化部署
- [ ] SemiClaw 官方提供原子化调用接口（Embedding、ReRank、LLM、文档解析等），并提供一定免费使用额度
- [ ] SemiClaw 官方提供完整云端服务，用户可在平台上直接体验 SemiClaw 能力
- [ ] 推出 SemiClaw Lite 版本，供私有化部署需求不强的用户快速体验产品能力
...
## IM 集成
- [x] 支持与企微、飞书等 IM 系统集成，在 IM 内使用 SemiClaw 能力

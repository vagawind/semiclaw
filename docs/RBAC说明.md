...
本文档介绍 SemiClaw **空间内权限控制（Workspace RBAC）** 的设计、角色矩阵、资源归属模型、配置方式，以及它与 [共享空间](./共享空间说明.md) 之间的关系。
...
<table>
  ...
  <tr>
    ...
    <td width="50%" align="center">
      ...
      <br/><sub>任何用户都可以自助创建空间，创建后自动成为新空间的 Owner（受 <code>SEMICLAW_TENANT_MAX_PER_USER</code> 上限保护）。</sub>
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">

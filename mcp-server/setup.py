...
setup(
    ...
    url="https://github.com/vagawind/semiclaw/tree/main/mcp-server",
    py_modules=["semiclaw_mcp_server", "upload_paths", "main", "run_server", "run", "test_module"],
    classifiers=[

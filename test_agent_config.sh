...
echo ""
echo "MySQL:"
echo "  mysql -u root -p semiclaw -e \"SELECT id, agent_config FROM tenants WHERE id = ${TENANT_ID};\""
echo ""
echo "PostgreSQL:"
echo "  psql -U postgres -d semiclaw -c \"SELECT id, agent_config FROM tenants WHERE id = ${TENANT_ID};\""
echo ""

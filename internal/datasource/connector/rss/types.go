// Package rss implements the RSS/Atom data source connector for SemiClaw.
//
// It syncs articles from one or more RSS/Atom/JSON feeds into a SemiClaw
...
// feed cannot redirect SemiClaw to internal services.
package rss

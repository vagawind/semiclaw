...
{"ok":false,"error":{"type":"input.confirmation_required",
  ...
  "retry_command":"semiclaw kb delete X -y","risk":{"level":"destructive","action":"kb.delete"}}}
```
...
| `semiclaw chat "..."` prints "garbled" stream | NDJSON by default; use `--format text` for a transcript |

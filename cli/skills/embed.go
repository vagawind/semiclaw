...
// `semiclaw skills install` can write them out without a source checkout
...
//go:embed all:semiclaw-shared all:semiclaw-rag-search
var fsys embed.FS
...
// root, e.g. "semiclaw-shared/SKILL.md"), sorted.

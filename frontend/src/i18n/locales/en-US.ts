export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and SemiClaw parses and indexes them automatically. Click here to open knowledge bases.'
      },
      chat: {
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: 'Keep a long-lived container per session on this SemiClaw host; scripts and files stay in that container',
      },
      ...
      dockerHostRisk: 'Empty or unix:// uses the Docker daemon on the SemiClaw host, which is equivalent to root on that machine. Use this only for a private single-node install. Prefer Cube or E2B when multiple workspaces share a host. Remote tcp:// endpoints require a TLS certificate directory.',
      ...
      templateLoadHint: 'Enter the cluster connection and refresh. Missing SemiClaw CLI templates are built from the official Hub image. Desktop templates are larger; create them from the row below. After changing DNS or the image, rebuild from that card.',
      ...
      templateUntaggedHint: 'The builds finished but none carries the default tag, so sandbox creation cannot resolve this template. Delete it in E2B and refresh; SemiClaw will rebuild it.',
      templateFailedReason: 'Build failed: {reason}',
      noTemplates: 'No templates were returned by this cluster.',
      semiclawStandardTemplate: 'SemiClaw standard template',
      ...
      semiclawDesktopTemplate: 'SemiClaw desktop template',
      ...
      replaceStandardTemplateConfirm: 'Rebuild the SemiClaw standard template with the current settings, including DNS. The previous spawnable template is not deleted until the replacement is ready.',
      desktopTemplateProvisioning: 'The SemiClaw desktop template is being created. Refresh shortly to see its status.',
      ...
      replaceDesktopTemplateConfirm: 'Rebuild the SemiClaw desktop template with the current settings, including DNS. The previous spawnable desktop template is not deleted until the replacement is ready. The CLI template is left untouched.',
    ...
    semiclawCloud: {
      ...
      description: 'Configure SemiClaw Cloud APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'SemiClaw Cloud credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'SemiClaw Cloud application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'SemiClaw Cloud application secret',
      ...
      credentialConfigured: 'SemiClawCloud credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'SemiClawCloud credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'SemiClawCloud credentials configured. See supported models in',
      modelHintDocsLink: 'API docs',
      modelsSection: {
        title: 'Cloud Models',
        descReady: 'Register the four standard SemiClaw Cloud models for chat, retrieval, reranking, and vision.',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'e.g. semiclaw/images',
      prefixPlaceholder: 'e.g. semiclaw',
  ...
  envVarSettings: {
    ...
    description: 'Personal keys for skills and sandboxes, not SemiClaw system or deployment settings.',
    ...
    nameInvalid: 'That name cannot be used. Names the sandbox reserves, such as PATH or anything starting with SEMICLAW_, are not accepted.',
  ...
  auth: {
    ...
    registerSubtitle: 'Create your account and start using SemiClaw',
  ...
  createChat: {
    title: 'Hi, I am SemiClaw — your knowledge, within reach',
  ...
  embedPublish: {
    ...
    originsHint: 'Enter the host websites allowed to embed this channel (A), not the SemiClaw address (B). One full origin per line, e.g. https://shop.example.com; at least one required. Supports *.example.com.',
  ...
  system: {
    ...
    versionDescription: 'Version of the application service (semiclaw-app)',
    frontendVersionLabel: 'UI Version',
    frontendVersionDescription: 'Build version of the UI (semiclaw-ui)',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        semiclawcloud: {
          name: 'SemiClaw Cloud',
          desc: 'Document parsing via SemiClaw Cloud'
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  integrations: {
    cli: {
      ...
      connectDesc: 'Create and activate a profile named semiclaw, then sign in with your email and password. If that profile already exists, choose another name and update the MCP example to match.',
      ...
      mcpDesc: 'After signing in, add this configuration to an MCP client that supports stdio. If the client cannot find semiclaw, set command to the absolute path of the binary.',
      copy: 'Copy',
      copied: 'Copied',
    },
    ...
    api: {
      ...
      capabilityManageModelsHint: 'Manage model definitions, credentials, connectivity checks, and SemiClawCloud credentials.',
      ...
      signedFlowDetail: 'Keep the HMAC secret only on SemiClaw and your trusted backend—never put it in requests or ship it to browsers. The request header carries the JWT string signed with that secret (it changes on each issuance or after expiry), not the secret itself. JWT must include sub (external user ID), tenant_id, aud=semiclaw, and exp (max 24h lifetime).',
      ...
      hmacSecretDesc: 'Same secret stored in SemiClaw; used only on your backend to sign JWTs—never send it as a request header.',
      ...
      signedRequestStep0: '# 0. Sign JWT on your backend (HS256, aud=semiclaw, sub=user id, tenant_id={tenantId}, exp<=24h)',
    ...
    chrome: {
      ...
      subtitle: 'For self-hosted SemiClaw: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On SemiClaw Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.'
        },
        install: {
    ...
    claw: {
      ...
      subtitle: 'Import documents and run hybrid retrieval (vector + keyword) via the SemiClaw REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
      ...
      ecosystemNote: 'Skill hosted on ClawHub ({\'@\'}lyingbug/semiclaw). See the ClawHub page for full API docs and version history.',
      installCta: 'Open ClawHub',
      installCtaHint: 'Install SemiClaw Skill · opens in a new tab',

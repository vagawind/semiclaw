#!/usr/bin/env python3
"""One-shot SemiClaw -> SemiClaw rebrand for text files.
...
REPLACEMENTS: list[tuple[str, str]] = [
    ("github.com/vagawind/semiclaw", "github.com/vagawind/semiclaw"),
    ("vagawind/semiclaw-mcp", "vagawind/semiclaw-mcp"),
    ("vagawind/semiclaw", "vagawind/semiclaw"),
    ("vagawind/semiclaw", "vagawind/semiclaw"),
    ("SemiClawCloud", "SemiClawCloud"),
    ("SemiClaw Lite", "SemiClaw Lite"),
    ("SemiClaw", "SemiClaw"),
    ("SemiClawLite", "SemiClawLite"),
    ("semiClaw", "semiClaw"),
    ("SEMICLAW", "SEMICLAW"),
    ("semi_claw", "semi_claw"),
    ("semiclaw", "semiclaw"),
...
# Placeholders must NOT contain "semiclaw" or they get corrupted during replacement.
PROTECT_URL = "https://weknora.weixin.qq.com"
PROTECT_WIRE = "weknoracloud"
